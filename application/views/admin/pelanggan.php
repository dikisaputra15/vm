    ...
    <div class="container-fluid">
        <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <center><h4 class="card-title">Data Pelanggan</h4></center>
                                <div class="table-responsive">
                                <a href="<?= base_url('admin/pelanggan/tambahpel'); ?>" class="btn btn-primary">+Tambah Data</a><br><br>

                                <form action="<?= base_url('admin/pelanggan/tombolpel'); ?>" method="POST">
                                   ...
                                   <input type="submit" name="1" class="btn btn-danger" value="Hapus">
                                   <input type="submit" name="2" class="btn btn-primary" value="Eksekusi">
                                   <input type="submit" name="3" class="btn btn-primary" value="Refresh">
                                </form>   
